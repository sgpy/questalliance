...
def saveQuestContext(req_json, user_input, reset=False):
    ...
    result = [context for context in output_contexts if context_filter(context)]
...
def questbot():
    ...
    if intent in intent_map:
        response_json = intent_map.get(intent)(user_input)
